...
msg.innerHTML = "Let's go " + player1 + " !";
    ...
    if (cell.innerHTML == "" && victory == false) {
      ...
      if (victory == true) {
        ...
        if (currentPlayer == player1) {
          scorePlayer1++;
          document.getElementById("score-player-1").innerHTML = ("Score: +"+scorePlayer1);
        }
        if (currentPlayer == player2) {
          scorePlayer2++;
          document.getElementById("score-player-2").innerHTML = ("Score: +"+scorePlayer2);
        }
      } else if (counter == 9 && victory == false) {
        msg.innerHTML = "DRAW !!!<br><a href=''>New Game</a>";
      } else {
